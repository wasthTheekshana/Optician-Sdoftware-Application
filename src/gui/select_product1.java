 ...
 * @author Theekshana
 */
public class select_product1 extends javax.swing.JFrame {

    /**
     * Creates new form select_product
     */
    public select_product1() {
        initComponents();
    ...
    JTextField j1, j2;
    public select_product1(JTextField j2, JTextField j3) {
        initComponents();
        loadtable();
        design();
...
;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(select_product1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new select_product1().setVisible(true);
            }
        });
    }
