 ...
 * @author Theekshana
 */
public class framCOst extends javax.swing.JFrame {
    ...
    JTextField j1, j2;
    public framCOst(JTextField j2, JTextField j3) {
        initComponents();
        loadtable();
        design();
...
;
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Stock Id", "Model", "Type", "Company", "Unit Price"
            }
        ));
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        String model = jTable1.getValueAt(row, 4).toString();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(framCOst.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    public void loadtable(){
        ...
        ResultSet rs = data.search("SELECT * FROM `stock` WHERE `TYPE` = 'frame'");
