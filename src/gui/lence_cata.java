 ...
 * @author Theekshana
 */
public class lence_cata extends javax.swing.JFrame {
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        try {
            data.iud("INSERT INTO `catgarylence`(`type`)VALUES('"+text+"')");
            loadpurpose();
        } catch (Exception e) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(lence_cata.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new lence_cata().setVisible(true);
            }
        });
    }
    ...
    public void loadpurpose(){
        try {
            ResultSet rs = data.search("SELECT COUNT(`Cat_lenceId`) FROM `catgarylence`");
            if(rs.next()){
