 ...
 * @author Theekshana
 */
public class fram_type extends javax.swing.JPanel {
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        try {
            data.iud("INSERT INTO `fr_type`(`type_name`)VALUES('"+text+"') ");
            jTextField1.setText("");
            loadType();
        } catch (Exception e) {
    ...
    public void loadType() {
        try {
            ResultSet rs = data.search("SELECT COUNT(`type_name`) FROM `fr_type`");
            if (rs.next()) {
