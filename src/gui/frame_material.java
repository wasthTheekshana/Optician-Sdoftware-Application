 ...
 * @author Theekshana
 */
public class frame_material extends javax.swing.JPanel {

    static frame_material r;
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Frame Material   : ");
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        try {
            data.iud("INSERT INTO `fr_material`(`material_name`)VALUES('"+text+"') ");
            jTextField1.setText("");
            loadmaterial();
        } catch (Exception e) {
    ...
    // End of variables declaration//GEN-END:variables
     ...
     public static frame_material matiral() {

        if (r == null) {

            r = new frame_material();
        }
        return r;
    ...
    public void loadmaterial(){
        try {
            ResultSet rs = data.search("SELECT COUNT(`material_name`) FROM `fr_material`");
            if(rs.next()){
