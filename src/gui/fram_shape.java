 ...
 * @author Theekshana
 */
public class fram_shape extends javax.swing.JPanel {
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        try {
            data.iud("INSERT INTO `fr_shape`(`shape`)VALUES('" + text + "') ");
            jTextField1.setText("");
            loadshape();
        } catch (Exception e) {
    ...
    public static fram_shape shape() {
    ...
    public void loadshape() {
        try {
            ResultSet rs = data.search("SELECT COUNT(`shape`) FROM `fr_shape`");
            if (rs.next()) {
