 ...
 * @author Theekshana
 */
public class lence_meterial extends javax.swing.JFrame {

    /**
     * Creates new form lence_purpose
     */
    public lence_meterial() {
        initComponents();
        loadpurpose();
    }
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        try {
            data.iud("INSERT INTO `lencematerial`(`material`)VALUES('"+text+"')");
            loadpurpose();
        } catch (Exception e) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(lence_meterial.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new lence_meterial().setVisible(true);
            }
        });
    }
    ...
    public void loadpurpose(){
        try {
            ResultSet rs = data.search("SELECT COUNT(`MaterialId`) FROM `lencematerial`");
            if(rs.next()){
